...
if __name__=='__main__':
    ...
    video_path = r'F:\Skill_Devlopment_2023\TIME_TABLES_2023\NOTES\Year-2024\_New_folder_\05Traffic_Monitoring_DAshboard_Using_Computer_Vision\Day 4\YoloXDeepsortDemo\detector.py (1)\video.mp4'
    ...
    vid_writer = cv2.VideoWriter(
        f'demo_{video_path}', cv2.VideoWriter_fourcc(*"mp4v"), fps, (int(width), int(height))
    ) # open one video
